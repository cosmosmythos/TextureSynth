...
void main() {
    ...
    vec4 _local_0;
    _local_0 = node_perlin(uv, node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 0], node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 1], node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 2], node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 3], node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 4], node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 5], node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 6], node_params[pc.param_ring_idx].v[pc.param_base_slot + 0 + 7]);
    vec4 _local_1;
    _local_1 = node_invert(uv, node_params[pc.param_ring_idx].v[pc.param_base_slot + 8], _local_0);
